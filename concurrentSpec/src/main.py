...
import sys
sys.path.append("../../../")
from concurrentSpec.src.custom_test_loader import CustomTestLoader
from concurrentSpec.src.custom_test_result import ShortTracebackResult
from concurrentSpec.src.feature import FeatureManager
from concurrentSpec.src.formatter.json_formatter import JsonFormatter
from concurrentSpec.src.reporter.test_result_summarizer import TestResultSummarizer
from concurrentSpec.src.reporter.test_result_xml_generator import generate_test_result_in_xml
from concurrentSpec.src.reporter.test_result_html_generator import generate_test_result_in_html

def main():
    supported_format = ["json", "json.pretty", "xml", "html"]
    parser = argparse.ArgumentParser()
    parser.add_argument("-p", "--path", help = "project path")
    parser.add_argument("-t", "--tags", action="append", nargs="+", help = "scenarios with the given tags will be executed")
